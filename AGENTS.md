...
- **No pull requests**: The user is the sole committer of this repository. Never create PRs — just push branches (or merge to the base branch) directly when asked.
